...
本章深入剖析水力模型专业团队的五个核心角色。说实话，很多团队根本没有这么多角色，可能一个人身兼数职——这很正常，但要知道理想状态是什么样的。

**工程师吐槽**：
> "我们团队只有三个人：一个管项目的、一个干活的、一个打杂的。看了这章才知道，原来'正规军'应该是五个人。"

**本章结构**：
- 4.1 项目经理（PM）：催进度的、挡箭牌的、背锅的
- 4.2 水力模型架构师：技术大佬、最后的防线
- 4.3 水力模型工程师：干活的、加班的、最苦逼的
- 4.4 数据分析师：整理数据的、救火的
- 4.5 AI工程师：新来的、搞事情的
- 4.6 角色协作与AI赋能：五角色如何不打架
